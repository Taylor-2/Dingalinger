...
wisdom=IntVar()							#Try integrating this section
...
# notesframe = Frame(root, bd=2, relief=GROOVE)
...
strengthvalue=Label(traitsframe,text=strength.get())
dexteritylabel=Label(traitsframe,text="Dexterity")
dexterityvalue=Label(traitsframe,text=dexterity.get())
constitutionlabel=Label(traitsframe,text="Constitution")
constitutionvalue=Label(traitsframe,text=constitution.get())
intelligencelabel=Label(traitsframe,text="Intelligence")
intelligencevalue=Label(traitsframe,text=intelligence.get())
wisdomlabel=Label(traitsframe,text="Wisdom")
wisdomvalue=Label(traitsframe,text=wisdom.get())
charismalabel=Label(traitsframe,text="Charisma")
charismavalue=Label(traitsframe,text=charisma.get())
...
#Notes
notelabel=Label(notesframe,text="Notes:")
notebox=Text(notesframe,wrap=WORD)

###########################################################################################################################
#Setting modules into frames

#Name
name.grid(row=0,column=0)#,sticky=EW)
raceandclass.grid(row=1,column=0)#,sticky=EW)
...
# notesframe.grid(row=5,columnspan=2,column=1)
